...
def main():
    ...
    for i in range(15, 16):
        ...
        with open("Dataset/output{}.txt".format(i), "w") as output:
            output.write(dna)
            if i < 6:
...
def reconstruct(file):
    ...
    with open(file, "r") as f:
        ...
        key = 0
        for line in f:
            # strand.append(line[:(len(line)-1)])  # -1 to cut off newline character
